    ...
    return (
      <>
        ...
        <div className="landing-container" style={{ background: 'transparent' }}>
          ...
          {!isAdminLogin && (
            <>
              <button type="button" className="google-btn" onClick={() => setShowGooglePopup(true)}>
                ...
                {activeSettingsTab === 'connectors' ? (
                  ...
                  <div style={{ padding: '20px 0' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '24px' }}>
                      <div>
                        <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: 'var(--t2)', marginBottom: '8px' }}>Name</label>
                        <input type="text" value={`${currentUser?.firstName || ''} ${currentUser?.surname || ''}`} readOnly style={{ width: '100%', padding: '10px 14px', background: 'var(--bg2)', border: '1px solid var(--gb)', borderRadius: '8px', color: 'var(--t1)', fontSize: '0.9rem', opacity: 0.7 }} />
                      </div>
                      <div>
                        <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: 'var(--t2)', marginBottom: '8px' }}>Email</label>
                        <input type="email" value={currentUser?.email || ''} readOnly style={{ width: '100%', padding: '10px 14px', background: 'var(--bg2)', border: '1px solid var(--gb)', borderRadius: '8px', color: 'var(--t1)', fontSize: '0.9rem', opacity: 0.7 }} />
                      </div>
                    </div>
                    <button className="btn btn-primary" style={{ width: 'auto', padding: '10px 20px', borderRadius: '8px', background: 'var(--a1)', color: '#fff', fontSize: '0.9rem' }}>Update Profile</button>
                    <div style={{ marginTop: '30px', paddingTop: '20px', borderTop: '1px solid var(--gb)' }}>
                      ...
                      <button className="btn" style={{ background: 'rgba(239, 68, 68, 0.1)', color: 'var(--err)', border: '1px solid rgba(239, 68, 68, 0.2)', padding: '10px 20px', borderRadius: '8px' }}>Delete Account</button>
                    </div>
                  </div>
                  ...
                  <div style={{ padding: '20px 0' }}>
                    ...
                    <button className="btn" style={{ background: 'transparent', color: 'var(--t1)', border: '1px solid var(--gb)', padding: '10px 20px', borderRadius: '8px', marginTop: '10px' }}>Download My Data</button>
                  </div>
